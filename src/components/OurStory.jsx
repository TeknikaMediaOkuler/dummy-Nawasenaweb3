        ...
        <section className="py-32 px-6 md:px-12 max-w-[1400px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24 mb-48">
                ...
                <div className="md:col-span-9 max-w-4xl">
                    <div
                        className={`relative overflow-hidden transition-all duration-700 ease-in-out ${isExpanded ? 'max-h-[1000px]' : 'max-h-[240px] md:max-h-[300px]'}`}
                    >
                        <div className="text-xl md:text-3xl font-medium leading-[1.4] md:leading-[1.4] text-nawasena-brown">
                            {fullText}
                        </div>

                        {/* Gradient Fade for collapsed state */}
                        {!isExpanded && (
                            <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-nawasena-cream to-transparent pointer-events-none" />
                        )}
                    </div>
                    ...
                    {!isExpanded && (
                        <button
                            ...
                            className="mt-6 text-lg font-medium underline underline-offset-4 decoration-black/20 hover:decoration-black transition-all"
                        >
                            More of us
                        </button>
                    )}
            ...
            <AnimatePresence>
                {isExpanded && (
                    ...
                    >
                        {/* The Management */}
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24 mb-32 border-t border-black/10 pt-24">
                            <div className="md:col-span-3">
                        ...
                        {/* The Team */}
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24 border-t border-black/10 pt-24">
                            <div className="md:col-span-3">
